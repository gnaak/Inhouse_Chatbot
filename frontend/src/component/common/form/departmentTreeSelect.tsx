  ...
  return (
    <div ref={boxRef} className={`relative inline-block w-full ${className}`}>
      ...
      <button
        ...
        disabled={disabled}
        className={`border border-gray-300 rounded-md bg-white w-full flex items-center justify-between hover:bg-gray-50 whitespace-nowrap
          ${sizeStyles.input}
        ...
        <>
          <div
            className={`
              ...
              min-w-full flex flex-col items-start h-fit max-h-[190px] overflow-y-auto
              ${sizeStyles.list}
              ${popupPosition}
              `}
          >
            ...
            <div className="py-1.5 w-full">
              {filteredTree.length === 0 ? (
                <div className="text-sm text-inputHeader py-4 text-center">
                  검색 결과가 없습니다
                </div>
              ) : (
