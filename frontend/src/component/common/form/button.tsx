...
const Button = ({
  ...
  const variants = {
    main: disabled
      ? "bg-main-active text-white/40 dark:bg-neutral-800 dark:text-neutral-500 cursor-not-allowed"
      : "bg-main hover:bg-main-hover active:bg-main-active text-white dark:bg-neutral-200 dark:hover:bg-neutral-100 dark:active:bg-neutral-300 dark:text-neutral-900",
