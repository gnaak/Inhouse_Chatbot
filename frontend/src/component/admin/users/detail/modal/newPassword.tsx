      ...
      <Modal
        ...
        description={
          <div className="flex flex-col gap-2 font-medium items-start">
            ...
            <div className="flex border border-neutral-200 bg-neutral-50 w-[320px] p-2 px-3 justify-between rounded-xl items-center">
              <span>{newPassword}</span>
              <button
                className="flex flex-row gap-1 bg-neutral-200 text-xs font-medium px-3 p-1 items-center rounded-lg hover:bg-neutral-300 transition-colors"
